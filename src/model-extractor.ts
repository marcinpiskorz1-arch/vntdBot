...
const BRAND_MODELS: Record<string, RegExp[]> = {
  ...
  "arc'teryx": [
    /alpha\s*(sv|ar|fl|sl)/i,
    /beta\s*(lt|ar|sv|sl)/i,
    /atom\s*(lt|ar|sl|hoody)/i,
    /cerium\s*(lt|sv)?/i,
    /gamma\s*(lt|mx|ar|sl)/i,
    /proton\s*(lt|fl)/i,
    /mantis\s*\d*/i,
    /granville/i,
    /arro\s*\d*/i,
